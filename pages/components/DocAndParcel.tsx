    ...
    return (
        <div className='w-[75%] relative mx-auto h-[700px] items-center flex justify-center'>
            <div className='absolute left-28 z-40 bg-white drop-shadow-lg rounded h-[560px] w-[550px] p-10'>
                <h2 className='text-3xl font-bold tracking-tighter my-4'>Document and Parcel Shipping</h2>
                <h3 className='text-2xl font-thin my-4  '>For All Shippers</h3>
                ...
                <div className='bg-gray-100 my-6 h-[170px] w-full left-0  absolute '>
                    <div>
                        <h4 className='ml-10 my-4 font-bold'>Services Available</h4>
                    ...
                    <button className='mt-8 ml-8 w-[90%] bg-[#D40511] text-white tracking-wider rounded text-lg p-4'>Explore DHL Express</button>

                </div>
            </div>
            <div className="bg-cover absolute right-0 w-[50%] h-[600px]  bg-[url('https://www.dhl.com/content/experience-fragments/dhl/en/core/sub_page_teaser/image_right_2_greycolumns/xbu_master_spt_dhl_home_document_and_package_shipping/_jcr_content/root/container_copy_copy/container_copy/image.coreimg.80.1197.jpeg/1655483113358/woman-signs-for-package-0002.jpeg')]">
            </div>
        </div>
    )
}
